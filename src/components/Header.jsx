...
export default function Header({ deleteBoardDialogRef, setIsNewColumn, selectedBoard, newTaskDialogRef, newBoardDialogRef, editBoardDialogRef, setSelectedBoard, setDarkMode, darkMode }) {
  const screenSize = useContext(ScreenSize);

  return screenSize >= 768 ?
    <HeaderTablet darkMode={darkMode} setDarkMode={setDarkMode} deleteBoardDialogRef={deleteBoardDialogRef} setIsNewColumn={setIsNewColumn} selectedBoard={selectedBoard} newTaskDialogRef={newTaskDialogRef} editBoardDialogRef={editBoardDialogRef} />
    :
    <HeaderMobile darkMode={darkMode} setDarkMode={setDarkMode} deleteBoardDialogRef={deleteBoardDialogRef} setIsNewColumn={setIsNewColumn} selectedBoard={selectedBoard} newTaskDialogRef={newTaskDialogRef} newBoardDialogRef={newBoardDialogRef} editBoardDialogRef={editBoardDialogRef} setSelectedBoard={setSelectedBoard} />;
}


function HeaderMobile({ deleteBoardDialogRef, setIsNewColumn, selectedBoard, newTaskDialogRef, newBoardDialogRef, editBoardDialogRef, setSelectedBoard, setDarkMode, darkMode }) {
  ...
  return (
    <>
      ...
      <header className={darkMode ? "dark-header-mobile" : "header-mobile"}>
            ...
            {isActive && (
              <div className="dropdown-content">
                ...
                <div className="toggle-container">
                  <img src="./img/moon-logo.svg" alt="Sun" />
                  <label className="toggle">
                    <input type="checkbox" onClick={() => setDarkMode(!darkMode)} />
                    <span className="slider"></span>
                  </label>
                  <img src="./img/sun-logo.svg" alt="Moon" />
                </div>
              </div>
            )}
          </div>
...
function HeaderTablet({ deleteBoardDialogRef, setIsNewColumn, selectedBoard, newTaskDialogRef, editBoardDialogRef, darkMode, setDarkMode }) {
  const [isDotActive, setDotActive] = useState(false);
  const toggleDotmenu = () => {
    setDotActive(!isDotActive)
  }
  ...
  return (
    <div className={darkMode ? "header-tablet-dark" : "header-tablet"}>
      <div className="header-tablet-left">
        <div className="side-bar-logo">
          <img src="./img/logo.svg" alt="" />
          <svg width="114" height="26" viewBox="0 0 114 26" fill={darkMode ? "#fff" : "#0c0c0c"} xmlns="http://www.w3.org/2000/svg">
